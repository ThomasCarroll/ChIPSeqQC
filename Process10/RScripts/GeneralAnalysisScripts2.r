...
Theresa_AR_Peaks_WithRepScore <- CountRepPeaks(Theresa_AR_Peaks)
AR_Peaks_WithRepScore <- RepPerGroup(Theresa_AR_Peaks_WithRepScore,SampleSheet,SampleSheet[,"SampleName"])
#save(AR_Peaks_WithRepScore,file="/lustre/mib-cri/carrol09/Work/NewTheresaSamples/RepsPerSample.RData")
load("/lustre/mib-cri/carrol09/Work/NewTheresaSamples/RepsPerSample.RData")
########
########
##Maybe....
#CountsPerSample <- GetCountsPerSample(AR_Peaks_WithRepScore,SampleSheet)
save(Counts_Peaks_WithRepScore,file="/lustre/mib-cri/carrol09/Work/NewTheresaSamples/CountsPerSample.RData")
load("/lustre/mib-cri/carrol09/Work/NewTheresaSamples/CountsPerSample.RData")
#colnames(CountsPerSample) <-
#Temp <- rowMeans(CountsPerSample)
elementMetadata(AR_Peaks_WithRepScore) <- cbind(as.data.frame(elementMetadata(AR_Peaks_WithRepScore)),CountsPerSample)


TotalColumn <- "Unique"
CountedPeakTable <-  AR_Peaks_WithRepScore
      Temp <- as.data.frame(elementMetadata(CountedPeakTable)[,grep("Processed.bam",colnames(elementMetadata(CountedPeakTable)))])
      LengthOfRegions <- width(CountedPeakTable)
      ##Insert 1 read...
      Temp[Temp == 0] <- 1
      RPK <- Temp/LengthOfRegions
      RPKM <- matrix(nrow=nrow(RPK),ncol=ncol(RPK))
      RPKMOverInput <- matrix(nrow=nrow(RPK),ncol=ncol(RPK))
      colnames(RPK) <- gsub("\\.bwa.*_Processed\\.bam","_RPK",colnames(RPK))
      for(c in 1:length(colnames(RPK))){
        SampleName <- gsub("_RPK","",colnames(RPK)[c])

        SampleName <- gsub("\\.bam$","",SampleName)
        SampleName <- gsub("_Processed$","",SampleName)
        SampleName <- gsub("\\.bwa.*","",SampleName)
        print(gsub("SLX\\.","SLX-",SampleName))
        RPKM[,c] <- RPK[,c]/as.numeric(SampleSheet[SampleSheet[,"GenomicsID"]  %in% gsub("SLX\\.","SLX-",SampleName),TotalColumn])
      }
      RPKM <- RPKM*1000000
      colnames(RPKM) <- gsub("RPK","RPKM",colnames(RPK))
      CountedPeakTable <-  cbind(CountedPeakTable,RPKM)

TempMeanRKM <- rowMeans(RPKM)
elementMetadata(AR_Peaks_WithRepScore) <- cbind(as.data.frame(elementMetadata(AR_Peaks_WithRepScore)),TempMeanRKM)
...
write.table(Atleast2_223_DHT_Not_In_MPA,"Atleast2_223_DHT_Not_In_MPA.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_223_DHT_Not_In_MPA","TempMeanRKM","250","Atleast2_223_DHT_Not_In_MPA.txt",sep=" "),wait=F,intern=F)

write.table(Atleast2_453_DHT_Not_In_MPA,"Atleast2_453_DHT_Not_In_MPA.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_453_DHT_Not_In_MPA","TempMeanRKM","250","Atleast2_453_DHT_Not_In_MPA.txt",sep=" "),wait=F,intern=F)


write.table(Atleast2_DHT_223_Not_In_453,"Atleast2_DHT_223_Not_In_453.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_DHT_223_Not_In_453","TempMeanRKM","250","Atleast2_DHT_223_Not_In_453.txt",sep=" "),wait=F,intern=F)



write.table(Atleast2_MPA_223_Not_In_453 ,"Atleast2_MPA_223_Not_In_453.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_MPA_223_Not_In_453","TempMeanRKM","250","Atleast2_MPA_223_Not_In_453.txt",sep=" "),wait=F,intern=F)


write.table(Atleast2_DHT_453_Not_In_223,"Atleast2_DHT_453_Not_In_223.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_DHT_453_Not_In_223","TempMeanRKM","250","Atleast2_DHT_453_Not_In_223.txt",sep=" "),wait=F,intern=F)



write.table(Atleast2_MPA_453_Not_In_223,"Atleast2_MPA_453_Not_In_223.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_MPA_453_Not_In_223","TempMeanRKM","250","Atleast2_MPA_453_Not_In_223.txt",sep=" "),wait=F,intern=F)


#############

write.table(Atleast2_223_DHT_Not_In_MPA,"Atleast2_223_DHT_Not_In_MPA.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_223_DHT_Not_In_MPA_400Window","TempMeanRKM","400","Atleast2_223_DHT_Not_In_MPA.txt",sep=" "),wait=F,intern=F)


write.table(Atleast2_453_DHT_Not_In_MPA,"Atleast2_453_DHT_Not_In_MPA.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_453_DHT_Not_In_MPA_400Window","TempMeanRKM","400","Atleast2_453_DHT_Not_In_MPA.txt",sep=" "),wait=F,intern=F)


write.table(Atleast2_DHT_223_Not_In_453,"Atleast2_DHT_223_Not_In_453.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_DHT_223_Not_In_453_400Window","TempMeanRKM","400","Atleast2_DHT_223_Not_In_453.txt",sep=" "),wait=F,intern=F)



write.table(Atleast2_MPA_223_Not_In_453 ,"Atleast2_MPA_223_Not_In_453.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_MPA_223_Not_In_453_400Window","TempMeanRKM","400","Atleast2_MPA_223_Not_In_453.txt",sep=" "),wait=F,intern=F)


write.table(Atleast2_DHT_453_Not_In_223,"Atleast2_DHT_453_Not_In_223.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_DHT_453_Not_In_223_400Window","TempMeanRKM","400","Atleast2_DHT_453_Not_In_223.txt",sep=" "),wait=F,intern=F)



write.table(Atleast2_MPA_453_Not_In_223,"Atleast2_MPA_453_Not_In_223.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","Atleast2_MPA_453_Not_In_223_400Window","TempMeanRKM","400","Atleast2_MPA_453_Not_In_223.txt",sep=" "),wait=F,intern=F)
...
write.table(TempSampleSheet,"SampleSheetForHeatmap.csv",sep=",",row.names=F)
write.table(Atleast2_223_DHT_Not_In_MPA,"Atleast2_223_DHT_Not_In_MPA.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","ForAverageAtleast2_223_DHT_Not_In_MPA","TempMeanRKM","250","Atleast2_223_DHT_Not_In_MPA.txt",sep=" "),wait=F,intern=F)

write.table(Atleast2_453_DHT_Not_In_MPA,"Atleast2_453_DHT_Not_In_MPA.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","ForAverageAtleast2_453_DHT_Not_In_MPA","TempMeanRKM","250","Atleast2_453_DHT_Not_In_MPA.txt",sep=" "),wait=F,intern=F)


write.table(Atleast2_DHT_223_Not_In_453,"Atleast2_DHT_223_Not_In_453.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","ForAverageAtleast2_DHT_223_Not_In_453","TempMeanRKM","250","Atleast2_DHT_223_Not_In_453.txt",sep=" "),wait=F,intern=F)



write.table(Atleast2_MPA_223_Not_In_453,"Atleast2_MPA_223_Not_In_453.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","ForAverageAtleast2_MPA_223_Not_In_453","TempMeanRKM","250","Atleast2_MPA_223_Not_In_453.txt",sep=" "),wait=F,intern=F)


write.table(Atleast2_DHT_453_Not_In_223,"Atleast2_DHT_453_Not_In_223.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","ForAverageAtleast2_DHT_453_Not_In_223","TempMeanRKM","250","Atleast2_DHT_453_Not_In_223.txt",sep=" "),wait=F,intern=F)



write.table(Atleast2_MPA_453_Not_In_223,"Atleast2_MPA_453_Not_In_223.txt",sep="\t",row.names=F)
system(paste("bsub -q bioinformatics -J R_8G -R \"rusage[mem=16000]\"  /lustre/mib-cri/carrol09/Work/MyPipe/R/R-2.15.0/bin/Rscript /lustre/mib-cri/carrol09/Work/NewTheresaSamples/MakeHeatmapScript.r","SampleSheetForHeatmap.csv","ForAverageAtleast2_MPA_453_Not_In_223","TempMeanRKM","250","Atleast2_MPA_453_Not_In_223.txt",sep=" "),wait=F,intern=F)
