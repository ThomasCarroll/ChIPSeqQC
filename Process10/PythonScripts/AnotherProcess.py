...
#LocationsDir = "/lustre/mib-cri/carrol09/Work/20121217_YoungA_MN_TFEB_ERTest/Locations/"
...
for ASampleID in SampleIDs:
	try:
		...
		for sampleProcessID in sampleProcessIDs:
			if sampleProcessID.solexaRun.runStatus == "COMPLETE":
				...
				print ASampleID
				if not sampleProcessID.solexaRun.multiplexed:
					if TempBam == "":
